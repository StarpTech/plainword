  ...
  return (
    <Section id="download">
      <Reveal className="relative text-center">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute top-[-40px] left-1/2 h-[200px] w-[380px] -translate-x-1/2 rounded-full bg-accent opacity-[0.10] blur-[80px]"
        />
        <div className="relative">
          <img
            src="/images/app-icon.png"
            alt=""
            className="mx-auto mb-7 h-18 w-18 rounded-tile shadow-paper-lift"
          />
