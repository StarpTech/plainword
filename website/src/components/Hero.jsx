    ...
    <header className="relative pt-14 pb-[clamp(56px,7vw,88px)] md:pt-24">
      <div className={`${CONTAINER} relative text-center`}>
        ...
        <div className="mt-14 flex flex-wrap justify-center gap-7 min-[1100px]:hidden">
          <Reveal className="flex w-[min(300px,86vw)] flex-col items-center gap-2.5">
            <HeroPopover {...correction} imgClassName="w-[70%]" />
          </Reveal>
          <Reveal delay={80} className="flex w-[min(300px,86vw)] flex-col items-center gap-2.5">
            <HeroPopover {...rewrite} imgClassName="w-full" />
          </Reveal>
          <Reveal delay={160} className="flex w-[min(300px,86vw)] flex-col items-center gap-2.5">
