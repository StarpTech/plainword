...
export const DOWNLOAD_URL =
  'https://github.com/StarpTech/plainword/releases/download/v1.0.0-beta.8/Plainword-1.0.0-beta.8-unsigned.dmg';
...
export const RECOMMENDED_MODELS = [
  ...
  },
  {
    ...
    text: 'Smarter than anything that fits on a laptop, and you only pay for the words you run through it. Your text goes to OpenAI.',
    points: [
      'Better at long threads and awkward rewrites',
      'Cheap enough that a month of writing is pocket change',
      'Still quick enough to feel fast',
    ],
    setup: 'Paste your key under Models, then pick openai/gpt-5.6-luna',
    mono: false,
    accent: false,
  },
];
